	...
	db['newsfeed_of_topic'].insert(
		[
			#대학교
			{
				...
				'info': 
				[
					'^main', '^library_', '^promotion_', '^classic_', '^counselor', '^skbs_', '^chong_', '_dormitory$', '^dodream_', '^mobilelibrary_', '^naverblog_sejong$'
				],
				'tag': 
				[
			...
			#자유
			{
				...
				'info': 
				[
					'^sejongstation_', '^everytime_', '_lost$'
				],
				'tag': 
				[
