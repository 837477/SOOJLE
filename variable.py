...
SJ_NO_TOKEN_RECOMMENDATION_LIMIT = 1000
...
SJ_FAV_TOPIC_WEIGHT = 8
SJ_VIEW_TOPIC_WEIGHT = 6
SJ_SEARCH_TOPIC_WEIGHT = 5
SJ_NEWSFEED_TOPIC_WEIGHT = 1

SJ_TOPIC_RESULT_DIV = 20
