...
function search_() {
    ...
    var saerch_text = $("#search_box").val();
     ...
     var newsfeed_list1 = A_JAX("http://127.0.0.1:5000/search_title", "POST", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1NzMwMzgzNzMsIm5iZiI6MTU3MzAzODM3MywianRpIjoiYWFmNTQ3MDQtYzdkYS00MTcwLWI1NmYtOTI4YWNhZTJlZmRjIiwiaWRlbnRpdHkiOiJ0ZXN0IiwiZnJlc2giOmZhbHNlLCJ0eXBlIjoiYWNjZXNzIn0.yDwdkgx_-ab_G-u0ko_UkOkijEiDxdyfDMEMrlBeOks", {'search': saerch_text});
     ...
     var newsfeed_list3 = A_JAX("http://127.0.0.1:5000/search_ft_token", "POST", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1NzMwMzgzNzMsIm5iZiI6MTU3MzAzODM3MywianRpIjoiYWFmNTQ3MDQtYzdkYS00MTcwLWI1NmYtOTI4YWNhZTJlZmRjIiwiaWRlbnRpdHkiOiJ0ZXN0IiwiZnJlc2giOmZhbHNlLCJ0eXBlIjoiYWNjZXNzIn0.yDwdkgx_-ab_G-u0ko_UkOkijEiDxdyfDMEMrlBeOks", {'search': saerch_text});
...
function search_all() {
    ...
    var saerch_text = $("#search_box").val();
     ...
     var newsfeed_list1 = A_JAX("http://127.0.0.1:5000/search_intergrate", "POST", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1NzMwMzgzNzMsIm5iZiI6MTU3MzAzODM3MywianRpIjoiYWFmNTQ3MDQtYzdkYS00MTcwLWI1NmYtOTI4YWNhZTJlZmRjIiwiaWRlbnRpdHkiOiJ0ZXN0IiwiZnJlc2giOmZhbHNlLCJ0eXBlIjoiYWNjZXNzIn0.yDwdkgx_-ab_G-u0ko_UkOkijEiDxdyfDMEMrlBeOks", {'search': saerch_text});
        $.when(newsfeed_list1).done(function () {
...
function refresh_() {
    ...
    var refresh_ = A_JAX("http://127.0.0.1:5000/refresh_measurement", "POST", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1NzMwMzgzNzMsIm5iZiI6MTU3MzAzODM3MywianRpIjoiYWFmNTQ3MDQtYzdkYS00MTcwLWI1NmYtOTI4YWNhZTJlZmRjIiwiaWRlbnRpdHkiOiJ0ZXN0IiwiZnJlc2giOmZhbHNlLCJ0eXBlIjoiYWNjZXNzIn0.yDwdkgx_-ab_G-u0ko_UkOkijEiDxdyfDMEMrlBeOks", {"LDA": LDA_BOX, "FAST": FT_BOX});
